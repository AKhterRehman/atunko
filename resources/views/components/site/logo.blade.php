...
<a href="{{ route('home') }}" class="flex items-center gap-3 group">
    ...
    <span class="leading-tight">
        <span class="block font-serif text-lg font-semibold tracking-wide {{ $dark ? 'text-white' : 'text-navy-900' }}">ATUNKO</span>
        <span class="block text-[0.65rem] font-medium tracking-[0.2em] text-gold-500">PARTNERSHIP</span>
    </span>
</a>
